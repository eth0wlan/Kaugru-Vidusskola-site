...
function videoLightbox () {
    ...
    $.fancybox({href:'#videocontent',fitToView:false,width:'70%',height:'70%',autoSize:true,closeClick:false,openEffect:'none',closeEffect:'none', padding: 3, fixed: fixedFlag, afterClose: function(){setTimeout($('.vep-videocontent').html(''), 100);}, helpers: {title: null, overlay : {opacity: 0.8, speedIn: 0, speedOut: 0}, buttons : {}}});
}

}

/*
     FILE ARCHIVED ON 17:49:53 Aug 18, 2012 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 14:35:16 Sep 19, 2026.
...
playback timings (ms):
  ...
  load_resource: 68.721
  PetaboxLoader3.resolve: 59.28
  PetaboxLoader3.datanode: 8.853
*/